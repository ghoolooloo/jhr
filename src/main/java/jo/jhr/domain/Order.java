...
public class Order implements Serializable {
    ...
    public Order memberSN(String memberSN) {
    ...
    public Order shopSN(String shopSN) {
        this.shopSN = shopSN;
        return this;
    }
    ...
    public Order shopName(String shopName) {
    ...
    public Order priceTotal(Integer priceTotal) {
    ...
    public Order cardReduce(Integer cardReduce) {
    ...
    public Order cards(String cards) {
        this.cards = cards;
        return this;
    }
    ...
    public Order rewardPointsReduce(Integer rewardPointsReduce) {
    ...
    public Order paymentTotal(Integer paymentTotal) {
    ...
    public Order distributionPlatform(DistributionPlatform distributionPlatform) {
    ...
    public Order deliveryNo(String deliveryNo) {
    ...
    public Order deliveryFee(Integer deliveryFee) {
    ...
    public Order contact(String contact) {
    ...
    public Order offsetType(OffsetType offsetType) {
    ...
    public Order packingFee(Integer packingFee) {
    ...
    public Order paymentMode(PaymentMethod paymentMode) {
    ...
    public Order diningDate(Instant diningDate) {
    ...
    public Order paidDate(Instant paidDate) {
    ...
    public Order expiredDate(Instant expiredDate) {
