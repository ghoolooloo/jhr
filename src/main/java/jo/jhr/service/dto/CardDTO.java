...
/**
 * A DTO for the {@link jo.jhr.domain.Card} entity.
 */
...
public class CardDTO implements Serializable {
    ...
    @Min(value = 0)
    @Max(value = 999999999)
    @ApiModelProperty(value = "已领取数量，需采用乐观锁更新")
     ...
     */
    @Size(max = 10)
    @ApiModelProperty(value = "兑换的菜品编号（兑换券专用）")
    private String gift;
     ...
     */
    @NotNull
    @ApiModelProperty(value = "卡券状态。这里只可能取 NEW 和 PUT 两种值", required = true)
