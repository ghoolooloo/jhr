...
/**
 * A DTO for the {@link jo.jhr.domain.ExceptionOrder} entity.
 */
...
public class ExceptionOrderDTO implements Serializable {
     ...
     */
    @NotNull
    @ApiModelProperty(value = "订单状态：DELIVERING（配送中）", required = true)
    ...
    public boolean equals(Object o) {
        ...
        ExceptionOrderDTO exceptionOrderDTO = (ExceptionOrderDTO) o;
        if (exceptionOrderDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), exceptionOrderDTO.getId());
    }
