...
import { CardHolderComponent } from 'app/entities/card-holder/card-holder.component';
...
describe('Component Tests', () => {
  describe('CardHolder Management Component', () => {
    let comp: CardHolderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CardHolderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cardHolders && comp.cardHolders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
