...
import { FinalCardComponent } from 'app/entities/final-card/final-card.component';
...
describe('Component Tests', () => {
  describe('FinalCard Management Component', () => {
    let comp: FinalCardComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FinalCardComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.finalCards && comp.finalCards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
