...
describe('Service Tests', () => {
  describe('RefundOrder Service', () => {
    let injector: TestBed;
    let service: RefundOrderService;
    let httpMock: HttpTestingController;
    let elemDefault: IRefundOrder;
    let expectedResult: IRefundOrder | IRefundOrder[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(RefundOrderService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new RefundOrder(
        0,
        'AAAAAAA',
        'AAAAAAA',
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a RefundOrder', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            diningDate: currentDate.format(DATE_TIME_FORMAT),
        ...
        service.create(new RefundOrder()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should update a RefundOrder', () => {
        const returnedFromService = Object.assign(
          {
            sn: 'BBBBBB',
            memberName: 'BBBBBB',
      ...
      it('should return a list of RefundOrder', () => {
        const returnedFromService = Object.assign(
          {
            sn: 'BBBBBB',
            memberName: 'BBBBBB',
      ...
      it('should delete a RefundOrder', () => {
