...
import { RefundOrderComponent } from 'app/entities/refund-order/refund-order.component';
...
describe('Component Tests', () => {
  describe('RefundOrder Management Component', () => {
    let comp: RefundOrderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RefundOrderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.refundOrders && comp.refundOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
