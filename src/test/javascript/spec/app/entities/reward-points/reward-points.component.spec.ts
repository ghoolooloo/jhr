...
import { RewardPointsComponent } from 'app/entities/reward-points/reward-points.component';
...
describe('Component Tests', () => {
  describe('RewardPoints Management Component', () => {
    let comp: RewardPointsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RewardPointsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rewardPoints && comp.rewardPoints[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
