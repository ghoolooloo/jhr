...
import { ClosedOrderComponent } from 'app/entities/closed-order/closed-order.component';
...
describe('Component Tests', () => {
  describe('ClosedOrder Management Component', () => {
    let comp: ClosedOrderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClosedOrderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.closedOrders && comp.closedOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
