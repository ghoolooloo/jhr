...
export class ClosedOrderComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-closed-order div table .btn-danger'));
  title = element.all(by.css('jhi-closed-order div h2#page-heading span')).first();
...
export class ClosedOrderUpdatePage {
  pageTitle = element(by.id('jhi-closed-order-heading'));
...
export class ClosedOrderDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-closedOrder-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-closedOrder'));
