...
export class ExceptionOrderComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-exception-order div table .btn-danger'));
  title = element.all(by.css('jhi-exception-order div h2#page-heading span')).first();
...
export class ExceptionOrderUpdatePage {
  pageTitle = element(by.id('jhi-exception-order-heading'));
...
export class ExceptionOrderDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-exceptionOrder-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-exceptionOrder'));
